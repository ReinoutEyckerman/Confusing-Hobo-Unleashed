...
namespace Confusing_Hobo_Unleashed
{
    public class MapDrawing
    {
        ...
        public static bool MapDrawn = false;
        ...
        {
            for (int xpos = 0; xpos < MapGeneration.RoomsHorizontal; xpos++)
            {
                for (int ypos = 0; ypos < MapGeneration.RoomsVertical; ypos++)
                {
        ...
        {
            int xposLoc = Xposmin + xpos*(HorizontalBlockLength + 2);
            int yposLoc = Yposmin + ypos*(VerticalBlockLength + 2);

            if (MapGeneration.Corridors[xpos, ypos, 0])
            {
                for (int z = 0; z <= VerticalBlockLength/2; z++)
                {
                    Console.SetCursorPosition(xposLoc, z + yposLoc);
                    Console.Write("|");
                }
                for (int z = VerticalBlockLength/2 + 2; z <= VerticalBlockLength; z++)
                {
                    Console.SetCursorPosition(xposLoc, z + yposLoc);
                    Console.Write("|");
                }
            ...
            {
                for (int z = 0; z <= VerticalBlockLength; z++)
                {
                    Console.SetCursorPosition(xposLoc, z + yposLoc);
                    Console.Write("|");
                }
            ...
            {
                for (int z = 1; z <= HorizontalBlockLength/2 - 1; z++)
                {
                    Console.SetCursorPosition(xposLoc + z, yposLoc);

                    Console.Write("-");
                }
                for (int z = HorizontalBlockLength/2 + 2; z <= HorizontalBlockLength - 1; z++)
                {
                    Console.SetCursorPosition(xposLoc + z, yposLoc);
            ...
            {
                for (int z = 1; z <= HorizontalBlockLength - 1; z++)
                {
                    Console.SetCursorPosition(xposLoc + z, yposLoc);
