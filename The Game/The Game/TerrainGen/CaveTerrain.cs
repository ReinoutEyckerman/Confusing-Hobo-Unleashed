...
namespace Confusing_Hobo_Unleashed.TerrainGen
{
    internal class CaveTerrain
    {
        ...
        {
            var y = TerrainGenerationModules.HCave(Console.WindowWidth/2, Console.WindowWidth, Game.CurrentLoadedMap.Mapheight - 1 - Random.Next(25, 35), Game.CurrentLoadedMap.Mapheight - 1 - Random.Next(5, 12));
        ...
        {
            var y = TerrainGenerationModules.HCave(0, Console.WindowWidth/2, Game.CurrentLoadedMap.Mapheight - 1 - Random.Next(25, 35), Game.CurrentLoadedMap.Mapheight - 1 - Random.Next(5, 12));
            TerrainGenerationModules.VCave(0, y, Console.WindowWidth/4 + Random.Next(-5, 5), Console.WindowWidth*3/4 + Random.Next(-5, 5));
            TerrainGraphics.Overlay(map, false);
        }
