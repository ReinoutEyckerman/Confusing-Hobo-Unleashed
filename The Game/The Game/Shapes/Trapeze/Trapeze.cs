...
namespace Confusing_Hobo_Unleashed.Shapes
{
    class Trapeze : ShapeDecorator
    {
        ...
        public Trapeze(Shape decoratedShape, Pixel pixel, Position position, Rectangle boundingBox, Window window) : base(decoratedShape, pixel, position, boundingBox, window)
        {
            this.pixel = pixel;
        }
