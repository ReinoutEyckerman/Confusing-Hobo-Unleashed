...
namespace Confusing_Hobo_Unleashed.User
{
    internal class InputHandler
    {
        public static Buttons ControlInputHandling()
        {
            ...
            do
            {
                if (Keyboard.IsKeyDown(Key.Up) ||
                    (controller && (GamePad.GetState(PlayerIndex.One).DPad.Up == ButtonState.Pressed)))
                    return Buttons.DPadUp;
                if (Keyboard.IsKeyDown(Key.Up) ||
                    controller && GamePad.GetState(PlayerIndex.One).ThumbSticks.Left.Y == 1)
                    return Buttons.LeftThumbstickUp;
                if (Keyboard.IsKeyDown(Key.Up) ||
                    controller && GamePad.GetState(PlayerIndex.One).ThumbSticks.Right.Y == 1)
                    return Buttons.RightThumbstickUp;
                if (Keyboard.IsKeyDown(Key.Down) ||
                    (controller && GamePad.GetState(PlayerIndex.One).DPad.Down == ButtonState.Pressed))
                ...
                if (Keyboard.IsKeyDown(Key.Left) ||
                    (controller && GamePad.GetState(PlayerIndex.One).DPad.Left == ButtonState.Pressed))
                    return Buttons.DPadLeft;
                if (Keyboard.IsKeyDown(Key.Left) ||
                    (controller && GamePad.GetState(PlayerIndex.One).ThumbSticks.Left.X == -1))
                    return Buttons.LeftThumbstickLeft;
                if (Keyboard.IsKeyDown(Key.Left) ||
                    (controller && GamePad.GetState(PlayerIndex.One).ThumbSticks.Right.X == -1))
                    return Buttons.RightThumbstickLeft;
                if (Keyboard.IsKeyDown(Key.Right) ||
                    (controller && GamePad.GetState(PlayerIndex.One).DPad.Right == ButtonState.Pressed))
                ...
                if (Keyboard.IsKeyDown(Key.Enter) ||
                    (controller && (GamePad.GetState(PlayerIndex.One).Buttons.A == ButtonState.Pressed)))
                    return Buttons.A;
                ...
                if (Keyboard.IsKeyDown(Key.Escape) ||
                    (controller && GamePad.GetState(PlayerIndex.One).Buttons.Back == ButtonState.Pressed))
                    return Buttons.Back;
        ...
        public static void AiHandling(Player player)
        {
            ...
            if (Game.Players[0].X - Game.Players[1].X < 10 && Game.Players[0].X - Game.Players[1].X >= 0 ||
                !(player.IsPossibleMove(Game.CurrentLoadedMap, Move.Right)))
            {
                if (random.Next(2) == 0) player.MoveLeft(Game.CurrentLoadedMap);
                else if (random.Next(15) == 0)
                    player.Jump(Game.CurrentLoadedMap);
            }
            else if (Game.Players[1].X - Game.Players[0].X < 10 && Game.Players[1].X - Game.Players[0].X > 0 ||
                     !(player.IsPossibleMove(Game.CurrentLoadedMap, Move.Left)))
            {
        ...
        public static void GameInputHandling()
        {
            ...
            if (Keyboard.IsKeyDown(Key.X) ||
                controller && GamePad.GetState(PlayerIndex.One).Buttons.Y == ButtonState.Pressed)
            {
        ...
        public static void GameInputHandling(int playernum)
        {
            ...
            if (Keyboard.IsKeyDown(Key.Escape) ||
                controller && GamePad.GetState(PlayerIndex.One).Buttons.BigButton == ButtonState.Pressed)
            {
                PauseMenu.ShowStartMenu(Game.GameBuffer);
            }
            if (Keyboard.IsKeyDown(Key.Q) ||
