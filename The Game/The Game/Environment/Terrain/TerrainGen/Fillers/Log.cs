...
namespace Confusing_Hobo_Unleashed.TerrainGen.Fillers
{
    public class Circle 
    {
        public Entity[,] fillCircle(Orientation orientation, Entity block, int width, int height, int start, int stop, int radius)
        {
            switch (orientation)
            {
        ...
        public Entity[,] log(Entity blocks, int width, int height, int startY, int endY)
        {
